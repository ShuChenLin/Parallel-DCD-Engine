/**
 * @file shape.h
 * @brief Convex shape data and shape factory helpers.
 */
...
/**
 * @brief Supported convex shape types in the benchmark scenes.
 */
...
/**
 * @brief Convex shape stored as a local-space vertex list.
 */
struct Shape {
    std::vector<Vec3> vertices;

    /**
     * @brief Returns the vertex furthest along a direction.
     */
    ...
    /**
     * @brief Builds a cube centered at the origin.
     */
    ...
    /**
     * @brief Builds a regular tetrahedron.
     */
    ...
    /**
     * @brief Builds a regular octahedron.
     */
    ...
    /**
     * @brief Builds an icosahedron used as a sphere-like proxy.
     */
...
/**
 * @brief Returns a shared vertex list for a shape type.
 */
...
/**
 * @brief Creates a Shape object from a shape type.
 */
...
/**
 * @brief Computes a world-space AABB for one shape instance.
 */
